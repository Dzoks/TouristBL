...
public class WeatherFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        final Menu mainMenu=((NavigationView)getActivity().findViewById(R.id.nav_view)).getMenu();
        mainMenu.findItem(R.id.nav_weather).setChecked(true);
    ...
    public class WeatherTask extends AsyncTask<Void,Void,ForecastWeather>{
        ...
        protected ForecastWeather doInBackground(Void... voids) {
            WeatherUtil weatherUtil=new WeatherUtil(API_KEY,getString(R.string.weather_lang));
    ...
    public void onResume() {
        super.onResume();
        ((NavigationView)getActivity().findViewById(R.id.nav_view)).getMenu().findItem(R.id.nav_weather).setChecked(true);
    }
}
